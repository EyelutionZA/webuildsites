...
Use this skill when creating, auditing, migrating, fixing, or preparing a website for Webuild-managed hosting.

This skill exists to stop AI-built websites from becoming fragile, inconsistent, unmaintainable, or hard to deploy.

The goal is not just to build a nice-looking website. The goal is to create a website that can be hosted, edited, monitored, backed up, migrated, and improved over time.
...
- migrating a completed website into the Webuild standard
- preparing a site for hosting
- fixing deployment/build issues
- adding forms, CMS, analytics, SEO, integrations, or app-like behaviour
- deciding whether a site should be static, dynamic, or app-hosted
...
Then build or migrate accordingly.
...
- landing pages
- brochure content
- basic forms via external webhook/service
- simple animations
- SEO pages
...
Do not treat web apps like normal websites.
...
Use extra dependencies only when they clearly reduce risk or improve maintainability.
...
## Required Structure for New Projects
